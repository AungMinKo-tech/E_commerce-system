				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								@if ($product->discount)
                                    <h3 class="product-price">{{ $product->price - ($product->price * $product->discount)/100 }} MMK <del class="product-old-price">{{ $product->price }} MMK</del></h3>
							...
							<ul class="product-links">
								<li>Category:</li>
								<li><h5>{{$product->category_name}}</h5></li>
							</ul>
						</div>
					</div>
					<!-- /Product details -->

    ...
    <div class="container-fluid">
        <div class="page-inner" style="margin-top: 100px">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <h3 class="fw-bold mb-0">Edit Voucher</h3>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin#voucherUpdate', $voucher->id) }}" method="POST">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" id="max_usage" class="form-control @error('max_usage') is-invalid @enderror"
                                               ...
                                               value="{{ old('max_usage', $voucher->max_usage) }}" min="1" required>
                                        @error('max_usage')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" id="start_date" class="form-control @error('start_date') is-invalid @enderror"
                                               name="start_date" value="{{ old('start_date', $voucher->start_date) }}" required>
                                        @error('start_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" id="end_date" class="form-control @error('end_date') is-invalid @enderror"
                                               name="end_date" value="{{ old('end_date', $voucher->end_date) }}" required>
                                        @error('end_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="d-flex gap-2 mt-4">
                                    ...
                                    <a href="{{ route('admin#voucherList') }}" class="btn btn-outline-secondary">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>

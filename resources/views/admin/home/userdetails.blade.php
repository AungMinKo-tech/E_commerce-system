                                ...
                                <div class="card">
                                    <div class="card-body text-center">
                                        <div class="profile-picture">
                                            <img src="{{ $user->profile ? asset('profile/' . $user->profile) : asset('default/default_profile.jpg') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-plaintext">
                                                <strong>{{ $user->created_at->format('F j, Y \a\t g:i A') }}</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
